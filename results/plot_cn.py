    ...
    def run(self):
        try:
            ...
            self._plot_grouped_bar(
                ...
                'Metric Value (%)',
                'cn_model_acc_f1_auc.png', focus_high=True
            )
            ...
            self._plot_grouped_bar(
                ...
                'Metric Value  (%)',
                'cn_pre_rec.png', focus_high=True
            )
            ...
            self._plot_grouped_bar(
                ...
                'Error Rate (%)',
                'cn_fnr_fpr.png', focus_high=False
            )

            self._plot_scatter_tradeoff(df, 'cn_scatter_fnr_fpr.png')

            print("\n🎉 所有图表绘制完成！")
        except Exception as e:
            print(f"❌ 发生错误: {e}")

def draw_all_plots(csv_path='results/csv/results_cn.csv'):
